      ...
      <Section bg="navy">
        <div className="max-w-2xl mx-auto text-center text-white">
          ...
          <p className="text-white/70 mb-8">
            Visit us at Lake Como Tourist Center, Via Borgo Vico 62 — 3 minutes from Como S. Giovanni train station - Connection with Milano Centrale, Milano Malpensa, Milano Porta Garibaldi, Lugano and Zurigo. Or contact us directly for availability and pricing.
          </p>
