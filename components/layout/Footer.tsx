    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://www.instagram.com/lakecomotouristcenter" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-light transition-colors">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider text-gold-light mb-4">Explore</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider text-gold-light mb-4">Contact</h3>
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li>
                <a href="https://www.instagram.com/lakecomotouristcenter" target="_blank" rel="noopener noreferrer" className="flex gap-2 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="mt-6">
              <Link
                href="/booking"
                className="inline-flex items-center gap-2 px-4 py-2 bg-gold-light text-navy text-sm font-semibold rounded-full hover:bg-gold-light transition-colors"
              >
                Book now →
              </Link>
            </div>
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between gap-4 text-xs text-white/40">
          <p>© {year} Lake Como Tourist Center. All rights reserved. VAT 04216820136</p>
